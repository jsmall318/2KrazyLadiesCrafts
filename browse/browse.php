	...
	<TABLE style="margin:auto; color:black;">
		<TR>
				...
				<TABLE class="list-group-item" style="background-color:white; width:300px;">
					...
					<TR>
						...
						<TD style="width:150px; text-align:center;">
							<SELECT name="searchBrand" id="searchBrand" style="color:black;" onchange="getOptions(searchModel);"></SELECT>
						</TD>
					</TR>
					<TR>
						<TD style="font-weight:bold; height:30px;">Model:</TD>
						<TD style="text-align:center;">
							<SELECT name="searchModel" id="searchModel" style="color:black;" onchange="getCapAndColor();"></SELECT>
						</TD>
					</TR>
					<TR>
						<TD style="font-weight:bold; height:30px;">Storage:</TD>
						<TD style="text-align:center;">
							<SELECT name="searchCapacity" id="searchCapacity" style="color:black;"></SELECT>
						</TD>
					</TR>
					<TR>
						<TD style="font-weight:bold; height:30px;">Color:</TD>
						<TD style="text-align:center;">
							<SELECT name="searchColor" id="searchColor" style="color:black;"></SELECT>
						</TD>
					</TR>
					<TR>
						<TD style="font-weight: bold">Maximum Price (whole dollar amounts only): </TD>
						<TD style="text-align:center;">$<INPUT type="text" name="maximumPrice" id="maximumPrice" size="10" maxlength="10"></INPUT>.00</TD>
					</TR>
					<TR>
			...
			<TD style="padding-left:25px;">
				<DIV class="list-group-item" style="background-color:white; width:650px;" data-ng-repeat="product in products">
					<H3>
